...
// ----------------------------------------------------
// ✅ FIX: The main client component logic is renamed
// ----------------------------------------------------
function BillingContent() {
  const { mutate } = useSWRConfig();
  const searchParams = useSearchParams(); // <-- Now deferred by the Suspense boundary below
...
// ----------------------------------------------------
// ✅ FIX: The new default export wraps the client logic in Suspense
// ----------------------------------------------------
